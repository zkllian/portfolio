          ...
          <div className="cv-hero">
            ...
            <div className="cv-hero-info">
              ...
              <div className="cv-contacts">
                <a className="cv-contact-item" href="mailto:llianified@gmail.com">
                ...
                <a className="cv-contact-item" href="tel:085199273883">
                  <svg className="cv-contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a className="cv-contact-item" href="https://twitter.com/llianified" target="_blank" rel="noreferrer">
                ...
                <a className="cv-contact-item" href="https://github.com/zkllian" target="_blank" rel="noreferrer">
                  <svg className="cv-contact-icon" viewBox="0 0 24 24" fill="currentColor">
