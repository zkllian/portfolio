      ...
      <footer className="p-footer">
        ...
        <div className="p-footer-right">
          <p className="p-footer-stats">
            ...
            {' | '}<span className="stats-online-inline"><span className="stats-online-dot" />{f.onlineLabel}</span> <strong className={onlineFlash ? 'stat-flash' : undefined}>#{online !== null ? online.toLocaleString() : '—'}</strong>
          </p>
