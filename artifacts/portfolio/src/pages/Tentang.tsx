  ...
  return (
    <div className="p-wrap">
      ...
      <p className="p-bio">
        ...
        Setelah sempat kerja di perpustakaan kampus, toko online, dan dunia pemasaran digital —
        nulis konten, urus media sosial, jalanin Facebook Ads — saya makin tertarik ke sisi teknis
        dan mulai belajar web development secara serius. Sekarang saya bisa bikin dan deploy website
        sendiri dari nol.
      </p>
      <p className="p-bio">
        Hubungi saya via{' '}
        <a href="https://wa.me/6285199273883" target="_blank" rel="noreferrer">WhatsApp</a>
        {' '}atau{' '}
        <a href="mailto:llianified@gmail.com">email</a>
        {' '}| lihat kode saya di{' '}
        <a href="https://github.com/zkllian" target="_blank" rel="noreferrer">GitHub</a>.
      </p>
      <p className="p-bio p-bio--last">
        Temukan saya di{' '}
        <a href="https://x.com/llianified" target="_blank" rel="noreferrer">Twitter / X</a>.
      </p>
      ...
      <div className="p-section">
        ...
        <div className="p-entry">
          ...
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Swisstronik</span>
              <span className="p-entry-date">sep 2024 – jan 2025</span>
            </div>
            <div className="p-entry-role">Brand Ambassador</div>
          </div>
        </div>
        ...
        <div className="p-entry">
          ...
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Story Protocol</span>
              <span className="p-entry-date">jul 2024 – apr 2025</span>
            </div>
            <div className="p-entry-role">Content Writer</div>
          </div>
        </div>
        ...
        <div className="p-entry">
          ...
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Union</span>
              <span className="p-entry-date">jul 2024 – apr 2025</span>
            </div>
            <div className="p-entry-role">Content Writer</div>
          </div>
        ...
        <div className="p-entry">
          <div className="p-entry-icon">M</div>
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Mitosis</span>
              <span className="p-entry-date">jul 2024 – apr 2025</span>
            </div>
            <div className="p-entry-role">Content Writer</div>
          </div>
        ...
        <div className="p-entry">
          <div className="p-entry-icon">N</div>
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Nesa</span>
              <span className="p-entry-date">mar 2024 – mei 2025</span>
            </div>
            <div className="p-entry-role">Brand Ambassador</div>
          </div>
        </div>
        ...
        <div className="p-entry">
          ...
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Injective</span>
              <span className="p-entry-date">jan 2024 – mar 2025</span>
            </div>
            <div className="p-entry-role">Brand Ambassador</div>
          </div>
        </div>
        ...
        <div className="p-entry">
          <div className="p-entry-icon">V</div>
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Verso</span>
              <span className="p-entry-date">mar 2018 – des 2019</span>
            </div>
            <div className="p-entry-role">Community Manager</div>
          </div>
        </div>

        <div className="p-entry">
          <div className="p-entry-icon">B</div>
          <div className="p-entry-body">
            <div className="p-entry-top">
              <span className="p-entry-co">Blog Independen</span>
              <span className="p-entry-date">2012</span>
            </div>
            <div className="p-entry-role">Blogger · Google AdSense</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-section">
        ...
        <div className="p-project">
          <div className="p-project-name">
            Llian Portfolio{' '}
            <span className="p-badge"><span className="p-badge-dot"></span>live</span>
          </div>
          <p className="p-project-desc">
            Situs portfolio pribadi ini — dibangun sendiri pakai React, Vite, dan TypeScript,
            karena saya mau buktiin bahwa saya bisa bikin sesuatu dari nol sampai online.
          </p>
          <div className="p-project-links">
            <a href="https://llian.vercel.app" target="_blank" rel="noreferrer" className="p-link">↗ kunjungi</a>
          </div>
        </div>
        ...
        <div className="p-project">
          ...
          <p className="p-project-desc">
            Generator barcode IMEI massal — layout adjustable, export langsung, untuk keperluan kerja sehari-hari di imei.org.
          </p>
          <div className="p-project-links">
        ...
        <div className="p-project">
          ...
          <p className="p-project-desc">
            Tool open source buat scraping data lowongan dari Jobstreet — dibuat karena capek cari loker satu-satu, jadi langsung otomatis sekaligus.
          </p>
          <div className="p-project-links">
            <a href="https://github.com/zkllian" target="_blank" rel="noreferrer" className="p-link">↗ github</a>
          </div>
        </div>
        ...
        <div className="p-project">
          ...
          <p className="p-project-desc">
            Tool open source berbasis otomasi untuk naikin volume tayangan AdMob tanpa harus intervensi manual — biar kerja di background sendiri.
          </p>
          <div className="p-project-links">
            <a href="https://github.com/zkllian" target="_blank" rel="noreferrer" className="p-link">↗ github</a>
          </div>
      ...
      <div className="p-section">
        ...
        <div className="p-skills">
          <div className="p-skills-group">
            <span className="p-skills-label">Web Dev</span>
            <div className="p-tags">
              {['Next.js','React','Vite','TypeScript','Tailwind CSS','Express.js','Drizzle ORM','TanStack Query','Wouter','Zod','Vercel','Telegram Bot','UI/Web Design'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
          <div className="p-skills-group">
            <span className="p-skills-label">Marketing</span>
            <div className="p-tags">
              {['Facebook Ads','SEO Dasar','Social Media Management','Content Planning'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
          <div className="p-skills-group">
            <span className="p-skills-label">Konten</span>
            <div className="p-tags">
              {['Community Management','Content Writing','Copywriting'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
          <div className="p-skills-group">
            <span className="p-skills-label">Desain</span>
            <div className="p-tags">
              {['Adobe Photoshop','Canva','Figma','Graphic Design'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
          <div className="p-skills-group">
            <span className="p-skills-label">Soft Skills</span>
            <div className="p-tags">
              {['Komunikasi','Kerja Tim','Problem Solving','Manajemen Waktu'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
          <div className="p-skills-group">
            <span className="p-skills-label">Bahasa</span>
            <div className="p-tags">
              {['Indonesia','Inggris'].map(t => (
                <span key={t} className="p-tag">{t}</span>
              ))}
            </div>
          </div>
      ...
      <div className="p-section">
        ...
        <p className="p-section-sub">Saya terbuka untuk kerja remote &amp; freelance. Bisa bergabung sebagai :</p>
      ...
      <div className="p-section">
        ...
        <div className="p-ai-row">
          <a href="https://chatgpt.com/?q=Siapa+Yoga+Aprilliansyah+N+Front-End+Developer+Bandung+llianified" target="_blank" rel="noreferrer" className="p-ai-btn" aria-label="Tanya di ChatGPT">
          ...
          <a href="https://claude.ai/new?q=Siapa+Yoga+Aprilliansyah+N+Front-End+Developer" target="_blank" rel="noreferrer" className="p-ai-btn" aria-label="Tanya di Claude">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.perplexity.ai/search?q=Yoga+Aprilliansyah+N+Front-End+Developer+Bandung" target="_blank" rel="noreferrer" className="p-ai-btn" aria-label="Tanya di Perplexity">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://gemini.google.com/app?q=Siapa+Yoga+Aprilliansyah+N+Front-End+Developer" target="_blank" rel="noreferrer" className="p-ai-btn" aria-label="Tanya di Gemini">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
