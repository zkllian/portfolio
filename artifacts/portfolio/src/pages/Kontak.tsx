      ...
      <div className="cv-wrap">
        ...
        <div className="cv-section reveal">
          ...
          <div className="cv-contacts">
            <a className="cv-contact-item" href={`mailto:${k.email}`} onMouseMove={onMagnet} onMouseLeave={offMagnet}>
            ...
            <a className="cv-contact-item" href={`tel:${k.phone}`} onMouseMove={onMagnet} onMouseLeave={offMagnet}>
              <svg className="cv-contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.5a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .84h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
              </svg>
              <span>{k.phone}</span>
            </a>
            <a className="cv-contact-item" href={l.twitter} target="_blank" rel="noreferrer" onMouseMove={onMagnet} onMouseLeave={offMagnet}>
              ...
              <span>{k.twitterHandle}</span>
            </a>
            <a className="cv-contact-item" href={l.github} target="_blank" rel="noreferrer" onMouseMove={onMagnet} onMouseLeave={offMagnet}>
              <svg className="cv-contact-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="cv-row-2col">
          <div className="cv-section reveal">
            ...
            <div className="cv-availability">
              ...
              <span>{k.availabilityStatus}</span>
            </div>
          ...
          <div className="cv-section reveal">
            ...
            <div className="cv-info-grid">
              <div className="cv-info-row">
                <span className="cv-info-key">{k.workPrefTypeKey}</span>
                <div className="cv-tags">
                  {k.workPrefTypes.map(t => (
                    <span key={t} className="cv-tag">{t}</span>
                  ))}
                </div>
              </div>
              <div className="cv-info-row">
                <span className="cv-info-key">{k.workPrefLocationKey}</span>
                <div className="cv-tags">
                  {k.workPrefLocations.map(loc => (
                    <span key={loc} className="cv-tag">{loc}</span>
                  ))}
                </div>
              </div>
            </div>
